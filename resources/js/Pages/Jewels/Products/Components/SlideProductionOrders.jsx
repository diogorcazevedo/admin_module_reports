...
export default function SlideProductionOrders({product,production_orders}) {
                                        ...
                                        <div className="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                                            <div className="px-4 sm:px-6">
                                                <div className="flex items-start justify-between">
                                                    <Dialog.Title className="text-sm font-medium text-teal-600"> Compras do produto: {product.name} </Dialog.Title>
                                                            ...
                                                            {production_orders?.map((data) => (
                                                                <tr key={data.id} className="divide-x divide-y divide-gray-200">
                                                                    ...
                                                                    <td className="text-xs p-2">
                                                                        {data.production_order?.manufacturer.name}
                                                                    </td>
                                                                </tr>
                                                            ))}
                                                            </tbody>

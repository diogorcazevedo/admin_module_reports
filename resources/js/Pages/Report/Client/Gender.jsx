...
export default function Gender({data,month,total}) {
                            ...
                            <div className="px-4 py-6 sm:px-6 lg:pl-8 xl:flex-1 xl:pl-6">
                                <table className="border mt-2 min-w-full divide-y divide-x divide-gray-200">
                                    ...
                                    <tr className="divide-x divide-y divide-gray-200">
                                        <th  className="text-gray-900 p-2">-</th>
                                        <th  width="15%" className="text-gray-900 p-2">compras</th>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td>Total: {new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(total) }</td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td>Tiket: {new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(total / count) }</td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>

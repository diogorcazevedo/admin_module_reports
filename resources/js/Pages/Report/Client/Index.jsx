...
import SlideGetRouteGenderAndYear from "@/Pages/Report/Client/Components/SlideGetRouteGenderAndYear";
import SlideGetRouteGenderAndYearAndMonth from "@/Pages/Report/Client/Components/SlideGetRouteGenderAndYearAndMonth";
                                ...
                                <ul role="list" className="py-4 grid grid-cols-1 gap-x-6 gap-y-8 lg:grid-cols-2 xl:gap-x-8">
                                        ...
                                        <dl className="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm leading-6">
                                            <div className="flex justify-between gap-x-4 py-3">
                                                <dt className="text-gray-500"><SlideGetRouteAndYear
                                                    get_route={'report.client.year_sales'} label={'faturamento anual'}/>
                                                </dt>
                                                <dt className="text-gray-500"><SlideGetRouteAndYearAndMonth
                                                    get_route={'report.client.month_sales'}
                                    ...
                                    <li className="overflow-hidden rounded-xl border border-gray-200">
                                        ...
                                        <dl className="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm leading-6">
                                            <div className="flex justify-between gap-x-4 py-3">
                                                <dt className="text-gray-500"><SlideGetRouteAndYear
                                                    get_route={'report.client.year_quantity'}
                                                    label={'quantidade anual'}/></dt>
                                                <dt className="text-gray-500"><SlideGetRouteAndYearAndMonth
                                                    get_route={'report.client.month_quantity'}
                                    ...
                                    <li className="overflow-hidden rounded-xl border border-gray-200">
                                        ...
                                        <dl className="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm leading-6">
                                            <div className="flex justify-between gap-x-4 py-3">
                                                <dt className="text-gray-500"><SlideGetRouteGenderAndYear gender="F" label={'faturamento anual'}/></dt>
                                                <dt className="text-gray-500"><SlideGetRouteGenderAndYearAndMonth gender="F"  label={'faturamento mensal'}/></dt>
                                            </div>
                                        </dl>
                                    </li>
                                    <li className="overflow-hidden rounded-xl border border-gray-200">
                                        ...
                                        <dl className="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm leading-6">
                                            <div className="flex justify-between gap-x-4 py-3">
                                                <dt className="text-gray-500"><SlideGetRouteGenderAndYear gender="M" label={'faturamento anual'}/></dt>
                                                <dt className="text-gray-500"><SlideGetRouteGenderAndYearAndMonth gender="M" label={'faturamento mensal'}/></dt>
                                            </div>
                                        </dl>
                                    </li>
                                    <li className="overflow-hidden rounded-xl border border-gray-200">
                                        ...
                                        <dl className="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm leading-6">
                                            <div className="flex justify-between gap-x-4 py-3">
                                                <dt className="text-gray-500"><SlideGetRouteAndYear
                                                    get_route={'report.client.year_cac'}
                                                    label={'quantidade anual'}/></dt>
                                                <dt className="text-gray-500"><SlideGetRouteAndYearAndMonth
                                                    get_route={'report.client.month_cac'}
                                                    label={'quantidade mensal'}/></dt>

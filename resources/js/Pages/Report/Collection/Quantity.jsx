...
import SlideCollectionProductsSortByOrders from "@/Pages/Report/Collection/Components/SlideCollectionProductsSortByOrders";
import SlideCollectionUsersSortByOrders from "@/Pages/Report/Collection/Components/SlideCollectionUsersSortByOrders";
                                ...
                                <table className="border mt-2 min-w-full divide-y divide-x divide-gray-200">
                                    ...
                                    {Object.values(sorted).map((item,index) => (
                                        <tr key={index} className="divide-x divide-y divide-gray-200">
                                            ...
                                            <td>
                                                <SlideCollectionProductsSortByOrders collection={item?.collection} products={item.pd} />
                                            </td>
                                            <td>
                                                <SlideCollectionUsersSortByOrders collection={item?.collection} users={item.users} />
                                            </td>
                                        </tr>
                                    ))}
                                    </tbody>

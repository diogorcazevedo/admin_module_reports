...
export default function Sales({data,month,total}) {
    ...
    function sellersLoop(index,item) {
        if(item.orders != 0  ){
          return  <tr key={index} className="divide-x divide-y divide-gray-200">
